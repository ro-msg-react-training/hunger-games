...
export const SingleDish: React.FC<SingleDishState> = (
    ...
    <div className="foodContainer">
      <div className="media has-text-centered">
        <div className="media-left">
          <div className="image">
            <img
              ...
              alt={"imageForFood" + props.currentFood.id_food}
            />
          </div>
        </div>
        <div className="media-content hideScrollBar">
          <div className="content">
            <div className="has-text-weight-medium has-text-white-ter is-size-5">
              {props.currentFood.food_name}
            </div>
            <br />
        ...
        <div className="media-right customHasCenteredContent">
          ...
          <div
            className={
              !props.isOutsideOfWorkingHours
                ? "is-hidden"
                : "button is-rounded addDishButtonActive"
            }
            onClick={() => {
              props.incrementOrdersForRestaurant(
