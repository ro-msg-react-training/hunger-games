...
export type PeacekeepersDetailedActionTypes =
  | PKDLoadUserOrdersAction
  | PKDChangePayedAmountAction
  | PKDChangeCardStatusAction
  | PKDPaymentFieldIsFocusedAction
  | PKDPaymentFieldLostFocusAction
  | PKDLoadOrdersToDetaileViewAction;
