...
export const PeacekeepersDetailedDumpView: React.FC<PeacekeepersDetailedViewState> = (
    ...
    return (
      <div className="hero is-dark is-bold custom-scroll-bar is-family-sans-serif">
        <div className="hero-head customHeadSpacing">
          <div className="container CustomHeaderBox has-text-centered">
            <div className="dropdown is-hoverable">
              <div className="dropdown-trigger">
                <div
                  id="paymentScreenRestaurantName"
                  className="has-text-black-ter has-text-weight-medium is-size-5"
                  aria-controls="additionalOrderInfoDrop"
                >
                  <Link
                    className="has-text-black-ter"
                    to={"/districts/" + props.currentOrder.restaurant.id}
                  >
                  ...
                  <div className="dropdown-item">
                    <div className="columns is-size-7 has-text-centered has-text-black-ter has-text-weight-medium is-vcentered">
                      <div className="column">
                        {"Order #" + props.currentOrder.order_id}
                      </div>
                      <div className="column">
                        {"Ordered by " +
                          props.currentOrder.placed_order_user.username}
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div
            className={
              props.enableCloseOrderButton(props)
                ? "button closeOrderButton"
                : "is-hidden"
            }
            onClick={() =>
              props.onClickCloseOrderButton(props, props.currentOrder.order_id)
            }
          >
        ...
        <div
          className={
            props.hasUserPlacedTheOrder
              ? "CustomStatsBox is-hidden-mobile"
              : "is-hidden"
          }
        >
          <div className="dropdown is-up is-hoverable">
            <div className="dropdown-trigger">
              <div
                className="columns has-text-centered has-text-grey-light"
                aria-controls="dropdown-menu4"
              >
                <div className="column">
                  {props.currentOrder.userOrders.length}{" "}
                  <FaLayerGroup className="is-size-7" />
                </div>
                <div className="column">
                  {props.currentOrder.restaurant.toPay + " lei"}
                </div>
                <div className="column">
                  {props.currentOrder.peopleLeftToPay}{" "}
                  <i className="fa fa-caret-down" />
                </div>
                <div className="column">
                  {props.currentOrder.peopleLeftToReceiveChange}{" "}
