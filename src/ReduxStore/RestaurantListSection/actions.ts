...
export function increadseNumberOfOrdersEventHandler(
...
export function decreadseNumberOfOrdersEventHandler(
...
export function reloadNumberOfOrdersEventHandler(
