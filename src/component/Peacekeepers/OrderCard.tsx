  ...
  return (
    <div className="column is-narrow is-static">
      <Link {...customLinkProperties}>
        <div
          className={
            props.orderIsActive ? "box OrderBoxActive" : "box OrderBoxInactive"
          }
        >
          <img
            className="orderCardImageActive"
            src={getRandomImage("restaurants")}
            alt={"imageForOrder" + props.order_id}
          />

          <div
            className={props.orderIsActive ? "is-hidden" : "inactiveOrderText"}
          >
          ...
          <div className="orderCardText">
            <div className="level">
              <div
                id="restaurantTitle"
                className="level-item has-text-centered has-text-grey-lighter has-text-weight-medium"
              >
            ...
            <div className="level has-text-grey-light has-text-weight-light has-text-left">
              ...
              <div
                id="placedByText"
                className="level-right level-item has-text-right"
              >
