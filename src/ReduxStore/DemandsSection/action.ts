...
export function newOrderItemEvent(
...
export function removeOrderItemEvent(
  orderToRemove: IDemands,
  crtActiveUser: IUser
): DTypes.DemOrderRemove {
  return {
...
export function removeOrderOnRestaurantEvent(
  itemsToRemove: IDemands[]
): DTypes.DemRemoveOrderOnRestaurant {
  return {
